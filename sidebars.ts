...
const sidebars: SidebarsConfig = {
  ...
  vrmSidebar: [
    ...
    // ライセンスなど
    {
      type: "category",
      label: "モデル情報",
      link: { type: "doc", id: "vrm/meta/index" },
      items: ["vrm/meta/license"],
    },
  ...
  vrm1Sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: "doc", id: "univrm1/vrm1_tutorial/firstperson" },
        {
          ...
          items: ["univrm1/vrm1_tutorial/springbone/center"],
        },
    ...
    "vrm1/lookat_firstperson",
    {
      ...
      items: ["vrm1/springbone/extended_collider"],
    },
    "vrm1/emission",
    "vrm1/mtoon",
    "vrm1/constraint",
  ...
  apiSidebar: [
    ...
    { type: "doc", id: "api/api_update" },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          label: "IncludeShaders",
          id: "api/project/include_shaders",
        },
      ],
    },
    {
          ...
          items: [
            {
              type: "doc",
              label: "vrm-1.0",
              id: "api/runtime-import/UniVRM10_Vrm10",
            },
            {
              type: "doc",
              label: "vrm-0.x",
              id: "api/runtime-import/VRM_VrmUtility",
            },
            {
              type: "doc",
              label: "glTF",
              id: "api/runtime-import/UniGLTF_GltfUtility",
            },
          ],
        },
        {
      ...
      items: [
        {
          ...
          items: [
            ...
            {
              type: "doc",
              label: "ExtendedCollider",
              id: "api/springbone/vrm1/VRMC_springBone_extended_collider",
            },
          ],
        },
        {
  ...
  releaseSidebar: [
    ...
    {
      type: "category",
      label: "v0.130(Unity6.0)~",
      items: [{ type: "autogenerated", dirName: "release/130" }],
    },
    {
      type: "category",
    ...
    "release/how_to_translation",
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "SpringBone",
          items: ["univrm/error/0_123_0_CapsuleCollider"],
        },
